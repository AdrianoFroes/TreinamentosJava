...
public class Matriz {
	...
	public static void main(String[] args) {
		 ...
		 for(int i = 0; i < notasJoao.length; i++) {
			 ...
			 for(double[] notasParaciais: notasPedro) {
				 for(double nota: notasParaciais) {
					 totalPedro += nota;
					 qtdeNotasPedro++;
				 }
				 
				 System.out.println("Notas Joao " + totalJoao / qtdeNotasJoao);
				 System.out.println("NOtas Pedro " + totalPedro / qtdeNotasPedro);
			 }
