...
public class Main {
	...
	public static void main(String[] args) {
		...
		Medico adriano = new Medico("Adriano ", "Ginecologista");
		Medico gabriela = new Medico("Gabriela ", "Obstetra");
		...
		Agenda agenda1 = new Agenda(adriano);
		agenda1.setData("22/10/2025  ");
		agenda1.adicionar(p1);
		agenda1.adicionar(p4);
		agenda1.apresentarListaPaciente();
		...
		agenda2.remover("111");
		agenda2.apresentarListaPaciente();
